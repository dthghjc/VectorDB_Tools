            ...
            <div className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h1 className="text-2xl font-bold">{t('signupForm.successTitle')}</h1>
                  <p className="text-muted-foreground text-balance">
                    {t('signupForm.successDescription')}
                  </p>
                </div>
                <Button 
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)}>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full" disabled>
                  ...
                  <span className="sr-only">{t('signupForm.signUpWithApple')}</span>
                </Button>
                <Button variant="outline" type="button" className="w-full" disabled>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <span className="sr-only">{t('signupForm.signUpWithGoogle')}</span>
                </Button>
                <Button variant="outline" type="button" className="w-full" disabled>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <span className="sr-only">{t('signupForm.signUpWithMeta')}</span>
                </Button>
              </div>
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        {t('signupForm.termsPrefix')} <a href="#">{t('signupForm.termsOfService')}</a>{" "}
        {t('signupForm.termsAnd')} <a href="#">{t('signupForm.privacyPolicy')}</a>。
      </div>
    </div>
  )
}
